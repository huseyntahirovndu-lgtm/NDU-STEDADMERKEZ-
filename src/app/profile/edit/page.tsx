...
/**
 * TEAM MEMBERS DÜZƏLTMƏ:
 * Formda string saxlayırıq (vergüllə ayrılmış),
 * submit zamanı array-ə çevirib Firestore-a elə göndəririk.
 */
const projectSchema = z.object({
  ...
  teamMembersRaw: z.string().optional(), // formda sadəcə string
...
function EditProfilePageComponent() {
  ...
  const onProfileSubmit: SubmitHandler<z.infer<typeof profileSchema>> = async (
    ...
    if (currentUser && currentUser.id === targetUser.id) {
      // Əvvəlki user obyektini saxlayıb üzərinə yazırıq
      updateUser({
        ...currentUser,
        ...payload,
      });
                ...
                >
                  ...
                  <FormItem>
                    ...
                    <div className="flex items-center gap-4">
                      <Avatar className="h-20 w-20">
                        <AvatarImage
                          src={profileForm.watch('profilePictureUrl')}
                        />
                        <AvatarFallback>
                          {getInitials(
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Təhsil Forması</FormLabel>
                          <FormControl>
                    ...
                    render={() => (
                      <FormItem>
                        ...
                        <div className="flex flex-wrap gap-2 pt-2">
                          {profileForm.getValues('skills')?.map((skill) => (
                            <Badge
                              key={skill.name}
                              variant="secondary"
